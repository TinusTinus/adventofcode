...
/**
 * Unit test cases for {@link RearrangementProcedureStep}.
 *
...
public class RearrangementProcedureStepTest {
    ...
    /**
     * Test case for {@link RearrangementProcedureStep#parse(String)}.
     */
    @Test
    public void testParse() {
        String input = "move 3 from 1 to 3";
        
        RearrangementProcedureStep step = RearrangementProcedureStep.parse(input);
