 ...
 */
public class ParabolicReflectorDishPart2 implements IntSolver {

    private static final Logger LOGGER = LoggerFactory.getLogger(ParabolicReflectorDishPart2.class);
    ...
    public static void main(String[] args) {
        var instance = new ParabolicReflectorDishPart2();
