...
public class OperationOrderPart2Test extends SolverTest<OperationOrderPart2> {
    ...
    public void testExample0() {
        testSolution("231", "example-day18-2020-0.txt");
    }
    ...
    public void testExample2() {
        testSolution("46", "example-day18-2020-2.txt");
    }
    
    /** Test case based on an example from the puzzle text. */
    @Test
    public void testExample3() {
        testSolution("1445", "example-day18-2020-3.txt");
    }
    
    /** Test case based on an example from the puzzle text. */
    @Test
    public void testExample4() {
        testSolution("669060", "example-day18-2020-4.txt");
    }
    
    /** Test case based on an example from the puzzle text. */
    @Test
    public void testExample5() {
        testSolution("23340", "example-day18-2020-5.txt");
    }
    
    /** Test case based on the examples from the puzzle text. */
    @Test
    public void testExample6() {
        testSolution("694173", "example-day18-2020-6.txt");
    }
    
    /** Test case based on the accepted solution. */
    @Test
    public void testSolution() {
        testSolution("231235959382961", "input-day18-2020.txt");
    }
}
