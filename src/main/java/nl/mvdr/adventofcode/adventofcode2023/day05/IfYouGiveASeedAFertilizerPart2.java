 ...
 */
public class IfYouGiveASeedAFertilizerPart2 implements Solver {

    private static final Logger LOGGER = LoggerFactory.getLogger(IfYouGiveASeedAFertilizerPart2.class);
    ...
    public static void main(String[] args) {
        var instance = new IfYouGiveASeedAFertilizerPart2();
